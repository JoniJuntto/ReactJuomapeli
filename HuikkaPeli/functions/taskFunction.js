export const createTask = () => {
    ...
    const list = [
        ...
        " jos susta tuntuu että peli on rigged juo 15 huikkaa",
        ...
        " saa päättää säännön",
        " saa päättää säännön, edellinen sääntö perutaan, jos sellainen on voimassa",
        ...
        " ota 25 huikkaa jos olet joskus sairastunut covid-19",
        ...
        "v alitse joku sana, se joka ensimmäisenä laulaa laulun, jossa mainittu sana esiintyy, jakaa 10 huikkaa",
        " saat päättää kumotaanko kaikki säännöt vai ei. Jos siis sääntöjä on jo olemassa",
        " jos olet kokeillut pHub premiumia karanteeniaikana ota 4 huikkaa",
        ...
        " jaa 5huikkaa mielestäsi fiksuimmalle",
        ...
        " jos sinulla on striimin chatti näkyvillä, juo 5 huikkaa",
        " jos sinulla on striimin chatti näkyvillä, chatti saa päättää sinulle tehtävän",
        ...
        ":lle sanon Moi! t. Huikka juo 4 huikkaa, koska miksi ei?",
        " istahda maahan ja juo lasisi tyhjäksi, jonka jälkeen saat nousta",
        " älä koske itseesi, pidetään korona kaukana!",
        ...
        " henkilö jonka nickin näät missä tahansa yhteydessä ensimmäisenä ottaa 4 huikkaa",
        ...
        " aloittaa, valitkaa järjestyksessä kenen joutuu ottaa huikkaa",
